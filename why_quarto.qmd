...
According to this [Intro to Quarto](https://charlotte.quarto.pub/cascadia/) workshop from Posit and the developers of Rstudio and Quarto, Quarto (compared to RMarkdown):
...
Be sure to check out the "Intro to Quarto" slides yourself, including the very [helpful section](https://charlotte.quarto.pub/cascadia/2-yaml-markdown-basics/) on rendering Quarto documents as pdfs.
