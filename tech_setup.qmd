...
Ideally before class on Thurs Sep 4, and definitely before class on Tues Sep 9, you should follow these instructions to set up the software that we'll be using throughout the semester. **Even if you've already downloaded both R and RStudio, you'll want to re-download to make sure that you have the most current versions.**
...
- **FIRST:** Download R [here](https://cran.rstudio.com/).
    ...
    - As of the start of this semester, the latest version of R is 4.5.1.
- **SECOND:** Download RStudio [here](https://posit.co/download/rstudio-desktop/#download).
    ...
    - As of the start of this semester, the latest version of RStudio is 2025.05.1 (Build 513).
