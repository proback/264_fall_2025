...
# Starter steps: navigate down to the section called "Getting a Census API key" and follow the instructions there
```
...
# I used the first line to store my NPS API key in .Renviron
# Sys.setenv("NPS_KEY" = "ZF32SPwMe828pFkbCVPKO56uNEkewSoYpAhCFrBE")
...
park_data
write_csv(park_data, "~/264_fall_2024/DS2_preview_work/park_data.csv")
# Use stringr to pick off individual activities, zip codes, etc.
```
