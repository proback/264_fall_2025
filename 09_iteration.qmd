...
You can download this .qmd file from [here](https://github.com/proback/264_fall_2025/blob/main/09_iteration.qmd).  Just hit the Download Raw File button.
...
df |> summarize(
  ...
  n = n()  # why should this come second?
)
...
# read_excel("https://proback.github.io/264_fall_2025/Data/gapminder/1952.xlsx")
...
2. use purrr::map() to read each of them into a list (we discussed lists more in 07_data_types.qmd)
