...
You can download this .qmd file from [here](https://github.com/proback/264_fall_2025/blob/main/13_maps.qmd).  Just hit the Download Raw File button.
...
vaccines <- read_csv("https://proback.github.io/264_fall_2025/Data/vacc_Mar21.csv") 
...
airbnb.df <- read_csv("https://proback.github.io/264_fall_2025/Data/airbnbData.csv") 
```
