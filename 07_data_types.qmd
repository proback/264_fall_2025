...
You can download this .qmd file from [here](https://github.com/proback/264_fall_2025/blob/main/07_data_types.qmd).  Just hit the Download Raw File button.
...
babynames <- read_csv("https://proback.github.io/264_fall_2025/Data/babynames_2000.csv")
...
```{r}
data_sci <- list(first = c("first it must work", 
                           "then it can be" , 
                           "pretty"),
