...
You can download this .qmd file from [here](https://github.com/proback/264_fall_2025/blob/main/11_web_scraping.qmd).  Just hit the Download Raw File button.
...
Please see `10_table_scraping.qmd` for a preview of web scraping techniques when no API exists, along with ethical considerations when scraping data.  In this file, we will turn to scenarios when the webpage contains data of interest, but it is not already in table form.  
