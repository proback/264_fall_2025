...
4. You might try having multiple inputs, or examining the [Shiny Widget Gallery](https://shiny.posit.co/r/gallery/widgets/widget-gallery/) and using an input we haven't discussed yet.
...
- [14a_AER_Shiny.Rmd](https://github.com/proback/264_fall_2025/blob/main/more_shiny/14a_AER_Shiny.Rmd)

- [14b_first_Shiny_flexdash.Rmd](https://github.com/proback/264_fall_2025/blob/main/more_shiny/14b_first_Shiny_flexdash.Rmd)


We will also use these folders as well.  You can copy the URL for the folder into the textbox at [download-directory.github.io](https://download-directory.github.io/), hit Enter, and you'll have a zipped version of the folder.

- [AER_app](https://github.com/proback/264_fall_2025/blob/main/AERapp)

- [Ames example](https://github.com/proback/264_fall_2025/blob/main/Ames_example)
